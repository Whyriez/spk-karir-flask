...
export default function Dashboard() {
    ...
    useEffect(() => {
        if (user) {
            const roleLabel = user.role === 'admin' ? 'Admin' : (user.role === 'pakar' ? 'Pakar' : 'Siswa');
            setHeader(
                <h2 className="font-semibold text-xl text-gray-800 leading-tight">Dashboard {roleLabel}</h2>
            );
        }
    }, [user, setHeader]);
                    ...
                    <div
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="mt-2 text-indigo-100 max-w-2xl">
                                Selamat datang di Sistem Pendukung Keputusan Karir. Pantau terus perkembangan potensimu
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex justify-between text-sm text-gray-600">
                                            ...
                                            <span className="font-bold">{latestHistory.skor_studi?.toFixed(3)}</span>
                                        </div>
                                        <div className="flex justify-between text-sm text-gray-600">
                                            <span>Minat Kerja</span>
                                            <span className="font-bold">{latestHistory.skor_kerja?.toFixed(3)}</span>
                                        </div>
                                        <div className="flex justify-between text-sm text-gray-600">
                                            <span>Wirausaha</span>
                                            <span
                        ...
                        <div className="overflow-x-auto">
                            <table className="min-w-full divide-y divide-gray-200">
                                ...
                                {history.length > 0 ? (
                                    ...
                                    <tr>
                                        <td colSpan={6} className="px-6 py-8 text-center text-gray-500 italic">Belum ada
                                            data riwayat.
                                        </td>
                                    </tr>
                                )}
