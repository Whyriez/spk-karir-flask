                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                        ...
                        <div className="overflow-x-auto">
                            <table className="min-w-full divide-y divide-gray-200">
                                ...
                                {data.length === 0 ? (
                                    <tr>
                                        <td colSpan={5} className="text-center py-4 text-gray-500">Belum ada data
                                            alumni.
                                        </td>
                                    </tr>
                                ) : data.map((item) => (
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <TextInput type="number" value={form.batch}
                                           onChange={(e) => setForm({...form, batch: e.target.value})}
                                           className="w-full mt-1" required/>
                            </div>
                            <div>
                                <InputLabel value="Jurusan Asal"/>
                                <TextInput value={form.major}
                                           onChange={(e) => setForm({...form, major: e.target.value})}
                                           className="w-full mt-1" placeholder="RPL/TKJ" required/>
                            </div>
                        </div>
                    </div>
