...
export default function InputKriteriaPakar() {
    ...
    return (
        <AuthenticatedLayout header={<h2 className="font-semibold text-xl text-gray-800">{id ? 'Edit' : 'Tambah'} Kriteria (Pakar)</h2>}>
            <div className="py-12">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    required
                                />
                                <p className="text-sm text-gray-500 mt-1">Pertanyaan ini akan muncul di halaman input siswa.</p>
                            </div>
